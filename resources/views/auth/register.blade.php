<x-guest-layout>
    ...
    <p class="text-sm text-muted-foreground mb-6 leading-relaxed">Langkah pertama alur magang: registrasi akun dan data alumni lulus UPA.</p>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-between gap-3 pt-2">
            <a class="text-sm text-center sm:text-left text-muted-foreground hover:text-ink underline underline-offset-2" href="{{ route('login') }}">
                Sudah punya akun?
            </a>
